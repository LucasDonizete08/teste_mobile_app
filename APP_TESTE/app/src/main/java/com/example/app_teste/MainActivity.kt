...
class MainActivity : AppCompatActivity() {
    ...
    fun teste1(V: View) {
        ...
        if (resposta_1.isVisible == false && resposta_2.isVisible == false&& resposta_3.isVisible == false) {
        ...
        else if(resposta_1.isVisible == false && resposta_2.isVisible == true&& resposta_3.isVisible == false){
            resposta1Param.setMargins(left, top+195, right, bottom);
            pergunta2Param.setMargins(left, top_2+195, right, bottom);
        ...
        else if(resposta_1.isVisible == false && resposta_2.isVisible == false&& resposta_3.isVisible == true){
            resposta1Param.setMargins(left, top+195, right, bottom);
            pergunta2Param.setMargins(left, top_2+195, right, bottom);
            pergunta3Param.setMargins(left, top_3+195, right, bottom);
        ...
        else if(resposta_1.isVisible == false && resposta_2.isVisible == true && resposta_3.isVisible == true){
            resposta1Param.setMargins(left, top+195, right, bottom);
            pergunta2Param.setMargins(left, top_2+195, right, bottom);
            resposta2Param.setMargins(left, top_2+390, right, bottom);
            pergunta3Param.setMargins(left, top_3+195, right, bottom);
    ...
    fun teste2(V: View) {
        ...
        if (resposta_2.isVisible == false && resposta_3.isVisible == false) {
        ...
        }else if (resposta_2.isVisible == false && resposta_3.isVisible == true) {
            resposta2Param.setMargins(left_2, top_2+195, right_2, bottom_2);
            pergunta3Param.setMargins(left_3, top_3+195, right_3, bottom_3);
